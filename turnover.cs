...
namespace ScoreLaxia
{
    public partial class turnover : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            // log the turnover for the player
            logAction(lPlayerName, lTeamName, activeTeamToLog, "turnovers");

            //update the label on the main form with the team turnover
            if (bHomeTeam == true)
            {
        ...
        private void updateMainFormLabel(string vTeam)
        {
            ...
            addGameSummaryRow(lTeamName, "Turnover");
        }
