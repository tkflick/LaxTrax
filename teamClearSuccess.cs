...
{
    public partial class teamClearSuccess : Form
    {
        ...
        {
            // log the clear..
            logAction(string.Empty, btnHomeTeam.Text, "homeTeamID", "teamClearSuccessful");
        ...
        {
            //log the clear..
            logAction(string.Empty, btnHomeTeam.Text, "visitingTeamID", "teamClearSuccessful");
        ...
        private void updateMainFormLabel(string vTeam)
        {
            ...
            addGameSummaryRow(lTeamName, "cleared the zone"); 
        }
